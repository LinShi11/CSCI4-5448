...
/**
 * The Crane class includes the getter/setter for all variables,
...
public class Crane implements Vehicle{
    ...
    // possible brands
    final ArrayList<String> brands = new ArrayList<>(Arrays.asList("Liebherr", "Cargotec", "Konecranes", "Manitowoc Cranes", "Palfinger"));
