...
/**
 * The Van class includes the getter/setter for all variables,
...
public class Van implements Vehicle{
    ...
    // possible brands
    final ArrayList<String> brands = new ArrayList<>(Arrays.asList("Hyundai", "Isuzu", "Iveco", "Jeep", "Jowett", "Kia"));
