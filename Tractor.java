...
/**
 * The Tractor class includes the getter/setter for all variables,
...
public class Tractor implements Vehicle{
    ...
    // possible brands
    final ArrayList<String> brands = new ArrayList<>(Arrays.asList("Mahindra", "John Deere", "Massey Ferguson", "Case IH", "Sonalika International"));
